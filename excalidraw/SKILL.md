...
**Setup:** If the user asks you to set up this skill (renderer, dependencies, etc.), run the setup commands in the **First-Time Setup** section below from this skill's directory.
